#![allow(missing_docs)]
use cr_websummary::{
    card_with_table, CardWithTable, GenericTable, MakePretty, Percent, TableRow, TitleWithHelp,
};
use serde::Serialize;
...
card_with_table!(
    ...
    columns: {
        ...
        num_cells: usize : "Number of cells",
        proportion: Percent : "Fraction of cells"
    }
);
