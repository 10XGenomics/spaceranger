...
def load_py_deps():
    ...
    new_conda_package_http_repository(
        ...
        urls = [
            "https://files.pythonhosted.org/packages/71/8a/c5f28f99a44e0913f0f86e315f04b51b3757a2353dedaa916c7997b4cb51/pyarrow-{}-cp312-cp312-manylinux_2_17_x86_64.manylinux2014_x86_64.whl".format(pyarrow_version),
        ],
